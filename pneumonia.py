...
st.error(f"⚠️ Model file '{model_path}' not found in current directory: {os.getcwd()}")
st.info("Please ensure 'pneumonia_model.h5' is in the same directory as this script.")
return None
...
return ['NORMAL', 'PNEUMONIA'], 0.40
except Exception as e:
st.warning(f"Error loading metadata: {e}. Using default values.")
return ['NORMAL', 'PNEUMONIA'], 0.40
